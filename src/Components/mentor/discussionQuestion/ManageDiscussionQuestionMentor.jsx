                ...
                <section id="contact" className="contact section " style={{ marginTop: "7vh" , marginBottom:"7vh" }}>
                    ...
                    {load ?
                        ...
                        <div className="container my-3" >
                             ...
                             <div className="col-md-2 " style={{marginBottom:"3vh"}}>
                                    <Link to={"/mentor/discussionQuestion/add"} className="btn btn-outline-primary">Add New +</Link>
                                </div>
...
<td>
  <Link to={"/mentor/discussionQuestion/edit/"+discussionQuestion?._id} className="btn btn-outline-success btn-md">
